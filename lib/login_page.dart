        ...
        child: Padding(   
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                width: 320, // Mengatur lebar container agar mengisi lebar layar
                decoration: BoxDecoration(
                  color: Color(0xFF3F7E45), // Warna latar belakang container
                  borderRadius: BorderRadius.circular(73.0), // Mengatur radius border container
                  boxShadow: [
                  BoxShadow(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Image.asset(
                      ...
                      height: 269.0, // Mengatur tinggi gambar
                      width: 184.0, // Mengatur lebar gambar
                      fit: BoxFit.cover, // Mengatur bagaimana gambar menyesuaikan ruang yang tersedia
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                width: double.infinity, // Mengatur lebar kolom username agar mengikuti lebar layar
                child: TextField(
                  controller: _usernameController,
                  decoration: InputDecoration(
                    prefixIcon: Icon(Icons.person), // Menambahkan icon di sebelah kiri teks username
                    labelText:_isUsernameFocused ? null :  'Username',
                    fillColor: Color(0xFFD9D9D9), // Warna latar belakang kolom username
              ...
              Container(
                ...
                obscureText:  _isObscure, // Menyembunyikan atau menampilkan password sesuai dengan nilai _isObscure
                decoration: InputDecoration(
                  prefixIcon: Icon(Icons.lock), // Menambahkan ikon kunci di sebelah kiri teks password
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  style: ElevatedButton.styleFrom(
                    minimumSize: Size(double.infinity, 50), // Mengatur ukuran tombol
                    backgroundColor: Color(0xFF425537), // Mengatur warna tombol
                ),
                child: Text(
                  'Login',
                  style: TextStyle(color: const Color.fromARGB(255, 255, 255, 255)), // Mengubah warna teks tombol login menjadi hijau),
                ),
              ),
            ],
          ),
